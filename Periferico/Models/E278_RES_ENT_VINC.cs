...
namespace Periferico.Models
{
    public class E278ResEntVinc
    {
        ...
        [DataMember(Name = "respuesta", IsRequired = true, Order = 8)]
        public String respuesta { get; set; }
        [DataMember(Name = "msgRespuesta", IsRequired = true, Order = 9)]
        public String msgRespuesta { get; set; }

        [DataMember(Name = "codError", IsRequired = true, Order = 10)]
        public string codError { get; set; }
        [DataMember(Name = "descError", IsRequired = true, Order = 11)]
