...
namespace Periferico.Models
{
    public class E271ConObs
    {
        ...
        [DataMember(Name = "coSubCobertura", IsRequired = true, Order = 16)]
        public string coSubCobertura { get; set; }
        [DataMember(Name = "teMsgLibre1", IsRequired = true, Order = 17)]
        public string teMsgLibre1 { get; set; }
        [DataMember(Name = "teMsgLibre2", IsRequired = true, Order = 18)]
        public string teMsgLibre2 { get; set; }
