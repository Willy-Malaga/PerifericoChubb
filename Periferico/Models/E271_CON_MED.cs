...
namespace Periferico.Models
{
    public class E271ConMed
    {
        ...
        [DataMember(Name = "coPaciente", IsRequired = true, Order = 14)]
        public string coPaciente { get; set; }
        [DataMember(Name = "apMaternoPaciente", IsRequired = true, Order = 15)]
        public string apMaternoPaciente { get; set; }

        [DataMember(Name = "listDetalleResponse", IsRequired = true, Order = 16)]
        public List<E271ConMedDetalle> listDetalleResponse { get; set; }

        [DataMember(Name = "codError", IsRequired = true, Order = 17)]
        public string codError { get; set; }
        [DataMember(Name = "descError", IsRequired = true, Order = 18)]
